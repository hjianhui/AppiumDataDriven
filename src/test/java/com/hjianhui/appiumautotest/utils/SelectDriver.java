package com.hjianhui.appiumautotest.utils;
	...
	public AppiumDriver<WebElement>selectDriver(ITestContext context, AppiumUtil appiumUtil){
		...
		androidAppPath = context.getCurrentXmlTest().getParameter("androidAppPath");
	      ...
	      if(platformName.equalsIgnoreCase("android")){
	    	...
	    	//capabilities.setCapability("app", "D:\\eclipseworkspace\\AppiumDataDriven\\res\\app\\android\\bing.apk");
		    //capabilities.setCapability("app", app);
		     ...
		     // capabilities.setCapability(MobileCapabilityType.TAKES_SCREENSHOT, "true");
	    	  ...
	    	  /**
				 * 设置ios  测试相关的capability并实例化driver对象
			   * */
