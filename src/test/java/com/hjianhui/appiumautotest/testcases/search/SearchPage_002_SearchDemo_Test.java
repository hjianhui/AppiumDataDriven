...
public class SearchPage_002_SearchDemo_Test extends BasePrepare {
	...
	@Test
  	public void searchDemo2() {  
		...
		//在搜索界面输入框输入Java
		SearchNativePageHelper.typeInfo(appiumUtil, SearchNativePage.SNP_INPUT_SEARCH, "Java");
		...
		//验证搜索的结果是否包含Java
//		SearchWebviewPageHelper.checkResultFitKeyWord(appiumUtil, "Java", SearchWebviewPage.SWP_LINK_DICTRESULT);
